      ...
      <section className="py-16 px-4 bg-gradient-to-r from-japan-navy to-japan-darkBlue text-white bg-gray-500">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="<div class=\"bg-gradient-to-r from-japan-red to-japan-lightRed rounded-xl p-6 shadow-lg border border-white/20 flex flex-col justify-center items-center text-center text-white\">\n    Your Content Here\n</div>\n">
